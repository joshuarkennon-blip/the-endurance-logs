    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex items-center justify-between px-4 md:px-5 py-2 md:py-3 border-b shrink-0"
        ...
        <div className="flex items-center gap-2 md:gap-3">
          ...
          <span className="text-[10px] md:text-[12px] tracking-[0.2em] md:tracking-[0.25em] uppercase" style={{ color: film.color }}>
            {film.transmission}
          </span>
        </div>
        <div className="flex items-center gap-2 md:gap-4">
          {/* Theme tags — hidden on mobile to save space */}
          ...
          {/* Mobile: back button */}
          <button onClick={onGoToShelf} className="console-btn md:hidden text-[10px] px-2 py-1">
            ← BACK
          </button>
      ...
      {visibleSections >= 1 && (
        <div className="px-4 md:px-6 pt-4 md:pt-5 pb-3 border-b border-console-border shrink-0 section-reveal">
          <div className="flex items-baseline gap-3 md:gap-4">
            <h1 className="text-3xl md:text-5xl font-bold tracking-[0.08em] md:tracking-[0.1em]"
          ...
          {/* Theme tags on mobile — shown below title */}
      ...
      {!film ? (
        <div className="flex flex-col items-center justify-center h-full gap-4 px-6 text-center">
          <div>
            ...
            <p className="text-[13px] md:text-[14px] tracking-[0.3em] text-console-muted uppercase">
              No Disc Loaded
            </p>
